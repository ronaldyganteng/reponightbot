...
CMD_HELP.update(
    {
         ...
         "\nExample: `.cbutton test [google]<buttonurl:https://www.google.com> [support]<buttonurl:https://t.me/NightCoreUserbot>`"
         "\n\n: `.ibutton`"
         "\nUsage: Buttons must be in the format as [Name on button]<buttonurl:link you want to open."
         "\nExample: `.ibutton test [google]<buttonurl:https://www.google.com> [support]<buttonurl:https://t.me/NightCoreUserbot>`"
